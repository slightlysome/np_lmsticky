...
*/
	...
	$oPluginAdmin  = new PluginAdmin('LMSticky');
	...
	{
		$oPluginAdmin->start();
		echo '<p>You must be logged in to use the LMSticky plugin admin area.</p>';
		$oPluginAdmin->end();
		exit;
	}
	...
	{
		$oPluginAdmin->start();
		echo '<p>You must be the blog super admin to use the LMSticky plugin admin area.</p>';
		$oPluginAdmin->end();
		exit;
	}
	...
	echo '<h2>LMSticky Administration</h2>';
